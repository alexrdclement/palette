...
// the divider color participates in theming via token-aware PaletteStyleScope.background().

@Composable
fun HorizontalDivider(
    modifier: Modifier = Modifier,
    thickness: Dp = DividerDefaults.Thickness,
    style: PaletteStyle = DividerDefaults.style,
) {
...
object DividerDefaults {
    ...
    val style: PaletteStyle get() = PaletteStyle { background(ColorToken.Outline) }
}
