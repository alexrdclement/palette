...
import com.alexrdclement.palette.app.demo.components.format.NumberFormatDemo
import com.alexrdclement.palette.app.demo.components.format.NumberFormatDemoState
import com.alexrdclement.palette.app.demo.components.format.rememberNumberFormatDemoControl
...
class NumberFormatScreenState(
    ...
    val numberFormatsByToken = NumberFormatToken.entries.associateWith { token ->
        token.toFormat(numberFormatScheme)
    }
